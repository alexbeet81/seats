...
ActiveRecord::Schema.define(version: 2021_09_05_064755) do
  ...
  create_table "seating_charts", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["class_group_id"], name: "index_seating_charts_on_class_group_id"
  end
  ...
  add_foreign_key "seating_charts", "class_groups"
